          ...
          <div className="flex justify-between gap-2 items-center">
            <div className="flex flex-col gap-5 flex-1 border p-5 bg-secondary-1 text-primary-1">
              ...
              <small className="text-center text-sm">
                Click on any planet to get more information about it, also you
                can click and drag to rotate the camera around the sun.
              </small>
            </div>
            ...
            <div className="flex flex-col gap-5 flex-1 border p-5 bg-secondary-1 text-primary-1">
              ...
              <small className="text-center text-sm">
                With the scroll wheel you can zoom in and out of the solar
                system.
              </small>
            </div>
          </div>
